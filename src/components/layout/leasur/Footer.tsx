...
const Footer = () => {
  return (
    <footer className="relative flex w-full flex-col items-center justify-center bg-[#2BA1DB] pb-40 pt-48 md:py-44">
      {/* Logo */}
      <Image
        ...
        width={348}
        height={100}
        className="mb-3 h-auto w-[348px] md:mb-3 md:h-[100px] md:w-[209px]"
      />
