...
const Issue = () => {
  return (
    <>
      ...
      <section
        id="issue"
        className="relative flex flex-col items-center gap-10 px-0 pb-0 pt-20 md:pt-10"
      >
        <div className="relative z-10 flex w-[63.75rem] flex-col gap-10 md:w-80">
          ...
          <div className="flex flex-col items-center gap-2 md:gap-2">
            ...
            <h2 className="font-gothic text-[30px] font-normal leading-[40px] text-white md:text-2xl">
              法に関するプロの皆様へ
            </h2>
          ...
          {/* Description text */}
          <div className="font-gothic text-base font-normal leading-[2] text-white md:text-sm md:leading-[1.6]">
            ...
            <p className="text-center">
              文書の体裁調整、条項参照の確認、表記の統一といったノンコア業務に多くの時間を奪われ、疲弊していませんか？
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative flex flex-col items-center gap-10 px-0 pb-20 pt-10 md:pt-10">
        <div className="relative z-10 flex w-[63.75rem] flex-col items-center gap-10 md:w-80">
          <h2 className="font-gothic text-[30px] font-normal leading-[40px] text-white md:text-2xl">
            その「見えないムダ」、もう終わりにしませんか？
          </h2>
          <div className="flex flex-col gap-2 md:gap-0">
            <p className="text-center font-gothic text-base font-normal leading-[2] text-white md:text-sm md:leading-[1.6]">
