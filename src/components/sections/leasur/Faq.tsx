        ...
        <div className="flex flex-col items-start gap-4 leading-[0]">
          ...
          <div className="relative inline-grid place-items-start gap-4">
            {FAQ_DATA.map((faq, index) => (
              <div
                key={index}
                className="flex w-[64.688rem] flex-col gap-[3px] rounded-[2px] border border-solid border-black bg-white px-8 py-4 font-gothic text-[#333333]"
              >
                {/* Question */}
                <p className="whitespace-pre text-[20px] leading-[28px]">
                  {faq.question}
                </p>

                {/* Answer */}
                <div className="whitespace-pre text-base leading-6">
