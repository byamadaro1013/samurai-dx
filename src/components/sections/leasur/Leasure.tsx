  ...
  return (
    <section className="relative flex size-full flex-col items-center gap-10 bg-[#2ba1db] px-0 py-20">
      <div className="relative flex w-[46.313rem] flex-col items-start gap-10 md:w-80">
        {/* Text Section */}
        <div className="relative flex w-full flex-col items-start gap-4 whitespace-nowrap text-white">
          <p className="relative whitespace-pre text-center font-helvetica text-[10px] font-bold leading-[10px]">
            ●LEASURE
          </p>
          <div className="relative whitespace-pre font-gothic text-[24px] leading-[1.5] tracking-[0.96px]">
            <p className="mb-0">
        ...
        <div className="relative flex w-[46.688rem] items-center justify-center gap-2">
          <div className="flex flex-col items-center gap-2">
            ...
            <button className="relative flex min-w-[20.938rem] items-center justify-between gap-5 border-2 border-solid border-white bg-transparent px-10 py-5 transition-colors hover:bg-white/10">
