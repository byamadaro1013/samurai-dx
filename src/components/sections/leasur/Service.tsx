      ...
      <div className="relative z-10 flex w-[64.375rem] flex-col gap-10 md:w-80">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="relative inline-flex items-start">
            <div className="absolute left-0 top-2 h-2 w-[624.417px] bg-white md:w-full"></div>
            <h2 className="relative font-gothic text-[30px] font-normal leading-[40px] text-[rgba(0,0,0,0.85)] md:text-[24px]">
              業務効率を爆上げする、リーソルの
              <span className="text-[40px] md:text-[32px]">7</span>
              つの機能
            </h2>
          </div>
        </div>
        ...
        {/* Description */}
        <p className="w-[61.813rem] font-gothic text-[20px] font-normal leading-[28px] text-[#333333] md:w-80 md:text-base">
        ...
        <div className="flex flex-col gap-10">
          {SERVICES.map((service, index) => (
            <div
              key={index}
              className="relative w-full rounded-[20px] bg-slate-100 p-10"
            >
              {/* Number Badge */}
                ...
                {index === 0 ? (
                  ...
                  <div className="flex flex-col gap-10">
                    ...
                    <div className="flex items-center gap-6">
                      <div className="h-[251.99px] w-[334px] flex-shrink-0 overflow-hidden rounded-[20px]">
                        <Image
                          src={service.image}
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <p className="w-[542px] font-gothic text-base font-normal leading-6 text-[#333333]">
                    ...
                    <div className="flex items-start gap-6">
                      <div className="h-[188px] w-[334px] flex-shrink-0 rounded-[10px] bg-white shadow-[0px_0px_45px_0px_rgba(0,0,0,0.1)]"></div>
                      <div className="flex flex-col gap-6">
                        {service.features?.slice(1).map((feature, i) => (
                          <div key={i} className="flex flex-col gap-2">
                            ...
                            <p className="w-[533px] font-gothic text-base font-normal leading-6 text-[#333333]">
                              {feature.description}
                            </p>
                          </div>
                        ))}
                      ...
                      {service.features && service.features.length > 0 ? (
                        service.features.map((feature, i) => (
                          <div key={i} className="flex flex-col gap-2">
                            ...
                            <p className="w-[480px] font-gothic text-base font-normal leading-6 text-[#333333]">
                              {feature.description}
                            </p>
                          </div>
                        ))
                      ) : service.bulletPoints ? (
                        <div className="flex w-[480px] flex-col gap-0 font-gothic text-base font-normal leading-6 text-[#333333]">
                          {service.bulletPoints.map((point, i) => (
                            <p key={i}>{point}</p>
                          ))}
                        </div>
                      ) : service.content ? (
                        <div className="flex w-[592px] flex-col gap-[3px]">
