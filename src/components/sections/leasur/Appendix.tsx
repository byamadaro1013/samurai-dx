...
const Appendix = () => {
  return (
    <section
      id="pricing"
      className="relative flex size-full flex-col items-center gap-10 px-0 py-20 md:px-9"
    >
      <div className="flex w-[64.375rem] flex-col items-start gap-10 md:w-full">
        ...
        <div className="flex flex-col items-start gap-2 md:gap-2">
          ...
          <div className="relative inline-grid place-items-start whitespace-nowrap font-gothic leading-[0] text-[#333333] md:whitespace-normal">
            <p className="relative whitespace-pre text-[20px] leading-[28px]">
              月額：5,000円/1ユーザー
            </p>
            <div className="relative mt-[31px] whitespace-pre text-base leading-6 md:mt-[3px] md:whitespace-normal">
              <p className="mb-0">
