        ...
        <div className="flex gap-10 md:flex-col md:gap-10">
          ...
          <div className="flex flex-1 flex-col">
            ...
            <div className="flex border-b border-[rgba(255,255,255,0.2)] py-5 md:py-5">
              <div className="w-[9.125rem] font-gothic text-[1rem] leading-[1.2] font-medium text-text-gray md:w-auto md:text-base">
                社名
              </div>
              <div className="flex-1 font-gothic text-[1rem] leading-[1.2] font-medium text-text-white md:text-base">
                株式会社 SamurAI DX
              </div>
            </div>
            ...
            <div className="flex border-b border-[rgba(255,255,255,0.2)] py-5 md:py-5">
              ...
              <div className="flex-1 font-gothic text-[1rem] leading-[1.6] font-medium text-text-white md:text-base">
                〒112-3456
                <br />
                まるまる県まるまる市まるまる区まるまる
              </div>
